...
export function makeSettingsRoutes(db: CuratDb): Hono {
  ...
  app.put('/', async (c) => {
    ...
    const numericBounds: Record<string, { min: number; max: number }> = {
      ...
      scoutPipelineBasicRes2160: { min: -200, max: 200 },
      scoutPipelineBasicRes1080: { min: -200, max: 200 },
      scoutPipelineBasicRes720: { min: -200, max: 200 },
      scoutPipelineBasicSourceRemux: { min: -200, max: 200 },
      scoutPipelineBasicSourceBluray: { min: -200, max: 200 },
      scoutPipelineBasicSourceWebdl: { min: -200, max: 200 },
      scoutPipelineBasicVideoHevc: { min: -200, max: 200 },
      scoutPipelineBasicVideoAv1: { min: -200, max: 200 },
      scoutPipelineBasicVideoH264: { min: -200, max: 200 },
      scoutPipelineBasicAudioAtmos: { min: -200, max: 200 },
      scoutPipelineBasicAudioTruehd: { min: -200, max: 200 },
      scoutPipelineBasicAudioDts: { min: -200, max: 200 },
      scoutPipelineBasicAudioDdp: { min: -200, max: 200 },
      scoutPipelineBasicAudioAc3: { min: -200, max: 200 },
      scoutPipelineBasicAudioAac: { min: -200, max: 200 },
      ...
      scoutPipelineBasicLegacyPenalty: { min: 0, max: 400 },
      scoutPipelineBasicSeedersDivisor: { min: 1, max: 500 },
      scoutPipelineBasicSeedersBonusCap: { min: 0, max: 200 },
      scoutPipelineBasicUsenetBonus: { min: -200, max: 200 },
      scoutPipelineBasicTorrentBonus: { min: -200, max: 200 },
