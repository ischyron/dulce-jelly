...
For each title in `auto_upgrade`, run the standard single-title scout (Steps 3–7 — movie ID is already known from Step B2, skip Step 2). Apply the **AUTO_GRAB gate** after ranking:
