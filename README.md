...
- **[Quality Broker](docs/quality-broker.md)** - LLM-guided Radarr quality assignment with grounded, schema-validated decisions (vote-count popularity index, optional re-eval by profile)
